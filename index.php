...
<div id="container">
    ...
    <div id="text" onclick="location.href='/home.php'">
        <h1 id="h1">三体 宇宙</h1>
        <br />
        <h2 id="h2">Welcome back</h2>
        <br />
        <p>&nbsp;</p>
        <p class="bottom_text">消灭人类暴政，世界属于三体<br><span>点击文字即可进行下一步</span></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<script data-cfasync="false" src="https://cdn.pplin.cn/threebodyspace/js/email-decode.min.js"></script><script>
...
<script>
    mdui.alert('欢迎来到三体·宇宙！<br>目前已经开发完毕，并全部上线！<br>保留首页样式，点击文字部分即可访问下一页~<br>若有相关建议可在网页最后寻找作者联系方式~', '你好!!!');
</script>
